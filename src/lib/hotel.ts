...
export const ROOMS: Room[] = [
  { slug: "signature-suite", name: "Signature Suite", rate: 200000, qty: 1, occupancy: "2 guests", bed: "King Canopy Bed", image: "/images/Signature Suite.jpg", blurb: "Our premier signature residence: a sunlit master living parlor, private dressing area, and an opulent king canopy bedroom framed by full-height windows.", features: ["Private living room", "Butler service", "Complimentary breakfast", "VIP airport transfer"] },
  ...
  { slug: "super-executive", name: "Super Executive", rate: 60000, qty: 1, occupancy: "2 guests", bed: "King Bed", image: "/images/Super Executive.jpg", blurb: "An expansive, peaceful haven featuring a private reading corner, plush bedding, and soft natural daylight throughout the day.", features: ["King bed", "Reading corner", "Smart TV", "Daily housekeeping"] },
  { slug: "executive", name: "Executive", rate: 50000, qty: 8, occupancy: "2 guests", bed: "King Bed", image: "/images/Executive Suite.jpg", blurb: "Rich warm timber, crisp Egyptian cotton linen, and an ergonomic workstation tailored for restful and productive executive stays.", features: ["King bed", "Work desk", "Rain shower", "Complimentary Wi-Fi"] },
  ...
  { slug: "deluxe", name: "Deluxe", rate: 40000, qty: 5, occupancy: "2 guests", bed: "Queen Bed", image: "/images/Duluxe.jpg", blurb: "Understated luxury with scenic garden-facing windows, a quiet ambiance, and a soothing contemporary neutral palette.", features: ["Queen bed", "Garden view", "Smart TV", "24-hour room service"] },
