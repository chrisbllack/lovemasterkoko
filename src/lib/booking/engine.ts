...
const DEFAULT_ROOM_TYPES: RoomType[] = [
  ...
  { id: "deluxe", slug: "deluxe", name: "Deluxe", qty: 5, baseRate: 4000000, maxOccupancy: 2, image: "/images/deluxe.jpg", blurb: "Understated luxury with scenic garden-facing windows and a soothing contemporary palette.", features: ["Garden view", "Smart TV", "24-hour room service", "Air conditioning"], status: "active" },
