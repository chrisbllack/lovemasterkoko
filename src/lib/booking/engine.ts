...
const DEFAULT_ROOM_TYPES: RoomType[] = [
  ...
  { id: "standard-plus", slug: "standard-plus", name: "Standard Plus", qty: 4, baseRate: 4500000, maxOccupancy: 3, image: "/images/Standard Plus.jpg", blurb: "An elevated retreat offering an extended lounge seating area, workspace, and serene courtyard views.", features: ["Seating area", "Smart TV", "Air conditioning", "Complimentary Wi-Fi"], status: "active" },
  { id: "deluxe", slug: "deluxe", name: "Deluxe", qty: 5, baseRate: 4000000, maxOccupancy: 2, image: "", blurb: "Understated luxury with modern ambient ceiling lighting, king-size comfort, flat-screen entertainment, and a soothing warm palette.", features: ["King size bed", "Smart TV", "Mood lighting", "Air conditioning", "Work desk"], status: "active" },
  ...
  { id: "standard", slug: "standard", name: "Standard", qty: 5, baseRate: 3000000, maxOccupancy: 2, image: "/images/Standard room.jpg", blurb: "A welcoming, quiet sanctuary featuring refined contemporary essentials, climate control, and dedicated service.", features: ["Smart TV", "Air conditioning", "Complimentary Wi-Fi", "En-suite bathroom"], status: "active" },
];
