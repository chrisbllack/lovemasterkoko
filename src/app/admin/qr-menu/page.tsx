    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-200 pb-5">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          >
            <FolderPlus className="h-4 w-4 text-[#ffbf00]" />
            <span>Categories ({categories.length})</span>
          </button>

          <button
            onClick={() => setIsAddingItem(true)}
            className="px-3.5 py-2 bg-[#ffbf00] hover:bg-[#e09e00] text-white rounded-lg text-xs font-semibold flex items-center gap-2 shadow-sm"
          >
                ...
                filteredItems.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-3 max-w-xs sm:max-w-md">
                      ...
                      <div className="text-[11px] text-[#ffbf00] font-medium">{item.categoryName}</div>
            ...
            <form onSubmit={handleSaveItem} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 rounded-lg border border-stone-300 text-stone-900 focus:outline-none focus:border-[#ffbf00]"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 rounded-lg border border-stone-300 text-stone-900 font-mono focus:outline-none focus:border-[#ffbf00]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 rounded-lg border border-stone-300 text-stone-900 focus:outline-none focus:border-[#ffbf00] resize-none"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-stone-200">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#ffbf00] hover:bg-[#e09e00] text-white font-semibold rounded-lg shadow"
                >
                  Save Item
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-stone-200">
            ...
            <form onSubmit={handleSaveCategory} className="space-y-3 pt-3 border-t border-stone-200 text-xs">
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-1.5 bg-[#ffbf00] text-white rounded-lg font-semibold"
                >
                  Add Category
                </button>
              </div>
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-stone-200 text-center">
            ...
            <div className="mb-4 text-left">
              ...
              <input
                ...
                className="w-full h-10 px-3 rounded-xl border border-stone-300 text-xs text-stone-900 focus:outline-none focus:border-[#ffbf00]"
              />
            </div>
            ...
            <div
              ...
              className="bg-[#191816] text-[#f4efe6] p-6 rounded-2xl border-2 border-[#ffbf00]/40 shadow-inner my-3"
            >
              ...
              <p className="text-[10px] uppercase font-mono tracking-widest text-[#ffbf00] mb-3">
              ...
              {qrRoomOrTable && (
                <div className="mt-3 inline-block px-3 py-1 rounded-full bg-[#ffbf00]/20 border border-[#ffbf00]/40 text-[#ffbf00] text-xs font-mono font-bold">
                  {qrRoomOrTable}
                </div>
              )}
